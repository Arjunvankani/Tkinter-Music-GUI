...
def Music_Player_GUI(song_dir_path,icon = None):
    ...
    ## Init Listbox
    listbox = Listbox(root, selectmode=ACTIVE, width=100, height=20, bg="#b3d9ff", fg="black")
    listbox.pack(fill=X)
    ...
    statusbar = Label(root, text="",bg = '#000000',fg = 'black', relief=SUNKEN, anchor=W, background='#b3d9ff',
                      font='Times 14 bold italic')
    statusbar.pack(side=BOTTOM, fill=X)

    previousbutton_color = Frame(root,borderwidth = 1, background="#b3d9ff")
    previousbutton = Button(previousbutton_color, text="◄◄", bg='#b3d9ff',activebackground = '#b3d9ff',fg = '#000000', width=15, height=2)
    previousbutton.pack(padx=1, pady=1)
    previousbutton_color.pack(side=LEFT)


    addplay_color = Frame(root,borderwidth = 1, background="#b3d9ff")
    addplay = Button(addplay_color, text="Repeat",bg = '#0080ff',activebackground = '#b3d9ff',fg = 'white', width=15, height=2)
    addplay.pack(padx=1, pady=1)
    addplay_color.pack(side=LEFT)

    play_song_color = Frame(root,borderwidth = 1, background="#b3d9ff")
    play_song = Button(play_song_color, text="Play",bg = '#0080ff',activebackground = '#b3d9ff',fg = 'white', width=15, height=2)
    play_song.pack(padx=1, pady=1)
    play_song_color.pack(side=LEFT)

    pausebutton_color = Frame(root,borderwidth = 1, background="red")
    pausebutton = Button(pausebutton_color , bg='cyan', text="║║",  width=15, height=2)
    pausebutton.pack(padx=1, pady=1)
    pausebutton_color.pack(side=LEFT)

    del_button_color = Frame(root,borderwidth = 1, background="#b3d9ff")
    del_button = Button(del_button_color , text="Delete",bg = '#0080ff',fg = 'white',activebackground = '#b3d9ff', width=15, height=2)
    del_button.pack(padx=1, pady=1)
    del_button_color.pack(side=LEFT)

    add_button_color = Frame(root,borderwidth = 1, background="#b3d9ff")
    add_button = Button(add_button_color, text="Add Song",activebackground = '#b3d9ff',bg = '#0080ff',fg = 'white', width=15, height=2)
    add_button.pack(padx=1, pady=1)
    add_button_color.pack(side=LEFT)

    nextbutton_color = Frame(root,borderwidth = 1, background="#b3d9ff")
    nextbutton = Button(nextbutton_color, text="►►", bg='#b3d9ff',activebackground = '#b3d9ff',fg = 'black', width=15, height=2)
    ...
    root.mainloop()
Music_Player_GUI(r'C:\Users\Arjun Vankani\Desktop\Music')